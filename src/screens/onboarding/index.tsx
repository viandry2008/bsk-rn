...
import { View, Text, Image, FlatList, Dimensions, StyleSheet, NativeScrollEvent, NativeSyntheticEvent } from "react-native";
            ...
            <FlatList
                ...
                renderItem={({ item, index }) => (
                    <View style={styles.page}>
                        ...
                        <Image source={item.image} style={index === 2 ? styles.topImage : styles.image} />
                        {index === 2 ? <View style={{ height: 265 }} /> : false}
                        <Text style={styles.title}>{item.title}</Text>
                        {index < 2 ? <Text style={styles.description}>{item.description}</Text> : null}
...
const styles = StyleSheet.create({
    ...
    nextButton: { backgroundColor: Colors.primary, paddingVertical: 10, paddingHorizontal: 40, borderRadius: 5 },
